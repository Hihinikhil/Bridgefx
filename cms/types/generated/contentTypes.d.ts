...
export interface ApiBrandSectionBrandSection extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Unified section for brand stats and logos';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    stats: Schema.Attribute.Component<'brand.stat', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPortfolioItemPortfolioItem
  ...
  info: {
    description: 'Work projects shown on the site';
  ...
  attributes: {
    ...
    isPhoto: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    layout: Schema.Attribute.Enumeration<['horizontal', 'vertical', 'square']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPricingPlanPricingPlan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pricing tiers shown on the site';
  ...
  attributes: {
    ...
    iconType: Schema.Attribute.Enumeration<['starter', 'diamond', 'brands']> &
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    layout: Schema.Attribute.Enumeration<['wide', 'tall', 'square']> &
    ...
    reviewVideo: Schema.Attribute.Media<
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Agency service offerings';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    iconType: Schema.Attribute.Enumeration<['video', 'design']> &
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Team members shown on the site';
